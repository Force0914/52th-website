...
<body>
    <div id="app" class="text-center">
        <div @mousemove="mousemove" @mouseup="mouseup">
            ...
            <div class="block" v-for="(item,index) in works" @dblclick="editwork(index)" @mousedown="mousedown(index)"
                :style="{'top':196+item.startTime*50+'px','left':200+item.location*180+'px','height':(item.endTime-item.startTime)*50+'px'}">
