...
<div id="app" class="text-center">
    ...
    <div class="block" v-for="(item, index) in works" :style="{'top': 207 + item.startTime*50 +'px','left': 190 + item.location*180 +'px','height':(item.endTime - item.startTime) * 50 + 'px'}" @dblclick="editwork(index)" ondragstart="dragstart(1)" draggable="true">
        <div>
    ...
    <div class="table-border">
        <table class="table table-striped work">
            ...
            <tbody>
                <tr v-for="i in time" ondrop="drop(event)" ondragover="allowdrag(event)" ondragenter="dragenter(event)">
